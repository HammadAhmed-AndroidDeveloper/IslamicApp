...
public abstract class Hilt_HadithFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HadithFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HadithFragment_GeneratedInjector) this.generatedComponent()).injectHadithFragment(UnsafeCasts.<HadithFragment>unsafeCast(this));
    }
  }
