...
public abstract class Hilt_PrayersTimingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PrayersTimingFragment() {
    super();
  }

  Hilt_PrayersTimingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PrayersTimingFragment_GeneratedInjector) this.generatedComponent()).injectPrayersTimingFragment(UnsafeCasts.<PrayersTimingFragment>unsafeCast(this));
    }
  }
