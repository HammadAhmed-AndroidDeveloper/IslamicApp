...
public abstract class Hilt_CalendarFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CalendarFragment() {
    super();
  }

  Hilt_CalendarFragment(int contentLayoutId) {
