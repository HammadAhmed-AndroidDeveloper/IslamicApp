...
public abstract class Hilt_IbadatFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_IbadatFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((IbadatFragment_GeneratedInjector) this.generatedComponent()).injectIbadatFragment(UnsafeCasts.<IbadatFragment>unsafeCast(this));
    }
  }
