...
public abstract class Hilt_QuranFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_QuranFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QuranFragment_GeneratedInjector) this.generatedComponent()).injectQuranFragment(UnsafeCasts.<QuranFragment>unsafeCast(this));
    }
  }
