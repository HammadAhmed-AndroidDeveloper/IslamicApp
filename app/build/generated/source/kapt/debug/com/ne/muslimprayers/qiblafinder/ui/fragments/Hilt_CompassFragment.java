...
public abstract class Hilt_CompassFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CompassFragment() {
    super();
  }

  Hilt_CompassFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CompassFragment_GeneratedInjector) this.generatedComponent()).injectCompassFragment(UnsafeCasts.<CompassFragment>unsafeCast(this));
    }
  }
