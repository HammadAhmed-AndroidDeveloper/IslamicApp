...
public abstract class Hilt_PrayerAlarmFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PrayerAlarmFragment() {
    super();
  }

  Hilt_PrayerAlarmFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PrayerAlarmFragment_GeneratedInjector) this.generatedComponent()).injectPrayerAlarmFragment(UnsafeCasts.<PrayerAlarmFragment>unsafeCast(this));
    }
  }
